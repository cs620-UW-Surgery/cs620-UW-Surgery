...
### What Works
- The agent pipeline correctly filters unsafe or out-of-scope questions
- RAG-based responses provide relevant, grounded, and cited medical information
- The UI supports structured outputs such as checklists and test instructions
- The system runs reliably with a properly configured OpenAI API

### What Doesn’t Work (Yet)
- Limited real-world validation with actual patients and clinicians
- Some edge cases may still bypass safety filters or require manual review
- Response quality can still be improved for complex or ambiguous queries
